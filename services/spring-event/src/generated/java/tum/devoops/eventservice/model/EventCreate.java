...
public class EventCreate {
  ...
  public EventCreate attendees(@Nullable List<String> attendees) {
  ...
  public EventCreate sportsLinked(@Nullable List<UUID> sportsLinked) {
  ...
  public EventCreate teamsLinked(@Nullable List<String> teamsLinked) {
