...
#   timestamp: 2026-07-02T13:04:22+00:00
...
class RagRequest(BaseModel):
    question: Annotated[
        str, Field(description='The question to answer from the PDF knowledge base.')
    ]
    uselocal: Annotated[
        bool | None,
        Field(
...
class RagResponse(BaseModel):
    response: Annotated[str, Field(description='The generated answer.')]
