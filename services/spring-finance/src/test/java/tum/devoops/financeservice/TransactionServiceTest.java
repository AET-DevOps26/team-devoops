...
class TransactionServiceTest {
    ...
    void updateTransactionAdminChangesMemberToExistingMember() {
        ...
        assertThat(result.getMember()).isEqualTo(newMemberId.toString());
    }
    ...
    void getAllBalancesAsAdminSumsTransactionsPerMember() {
        ...
        assertThat(result).extracting(Balance::getMember, Balance::getBalanceCents)
                .containsExactlyInAnyOrder(
                        tuple(MEMBER_ID.toString(), 300),
                        tuple(otherMember.toString(), 50));
    }
    ...
    void getAllBalancesAsDirectorSumsManagedMembersOnly() {
        ...
        assertThat(result).extracting(Balance::getMember, Balance::getBalanceCents)
                .containsExactly(tuple(MEMBER_ID.toString(), 70));
    }
