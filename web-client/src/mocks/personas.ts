...
// Persona ids are real members in the fixtures; `coach` maps to server role `trainer`.
export interface MockPersona { id: string; role: Role; name: string; email: string }
