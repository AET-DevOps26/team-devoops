...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn(
        "group/menu-item relative group-data-[collapsible=icon]:[&>[data-sidebar=menu-button]]:mx-auto",
        className
      )}
      {...props}
    />
