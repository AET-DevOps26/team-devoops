...
export const transactionFixtures: Transaction[] = [
  {
    ...
    "member": { id: "99999999-0013-0001-be1e-0000000bbe15", name: "Marie Wolf" },
    "creator": null,
    "amount_cents": -3000,
  ...
  },
  {
    ...
    "member": { id: "99999999-0013-0001-be1e-0000000bbe15", name: "Marie Wolf" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2000,
  ...
  },
  {
    ...
    "member": { id: "99999999-0014-0001-5c55-0000000c5c4c", name: "Linus Koch" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2000,
  ...
  },
  {
    ...
    "member": { id: "99999999-0017-0001-36fb-0000000e36f1", name: "Edda Frank" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2500,
  ...
  },
  {
    ...
    "member": { id: "99999999-0018-0001-d533-0000000ed528", name: "Mia Werner" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2000,
  ...
  },
  {
    ...
    "member": { id: "99999999-002b-0002-9351-0000001a933d", name: "David Arnold" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2000,
  ...
  },
  {
    ...
    "member": { id: "99999999-002e-0002-6df7-0000001c6de2", name: "Wilma Kaiser" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2500,
  ...
  },
  {
    ...
    "member": { id: "99999999-0035-0003-c17c-00000020c163", name: "Helena Berger" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2500,
  ...
  },
  {
    ...
    "member": { id: "99999999-0038-0003-9c22-000000229c08", name: "Greta Nowak" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2000,
    "created_at": "2026-03-31T00:00:00.000Z",
    "title": "Monthly dues",
  ...
  },
  {
    ...
    "member": { id: "99999999-0048-0004-7f9a-0000002c7f78", name: "Levi Lange" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2500,
    "created_at": "2026-03-07T00:00:00.000Z",
    "title": "Court fee",
  ...
  },
  {
    ...
    "member": { id: "99999999-0049-0004-1dd1-0000002d1daf", name: "Henry Richter" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2500,
  ...
  },
  {
    ...
    "member": { id: "99999999-004d-0004-96af-0000002f968b", name: "Frida Fuchs" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2500,
    "created_at": "2026-06-13T00:00:00.000Z",
    "title": "Court fee",
  ...
  },
  {
    ...
    "member": { id: "99999999-0050-0005-7156-000000317130", name: "Finn Seidel" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -2500,
    "created_at": "2026-05-27T00:00:00.000Z",
    "title": "Court fee",
  ...
  },
  {
    ...
    "member": { id: "99999999-0063-0006-2f74-0000003d2f45", name: "Lena Beck" },
    "creator": { id: "99999999-0004-0000-78dd-0000000278dc", name: "Admin Devoops" },
    "amount_cents": -1500,
    "created_at": "2026-05-23T00:00:00.000Z",
    "title": "Tournament entry",
...
export const balanceFixtures: Balance[] = [
  ...
  {
    "member": { id: "99999999-0061-0006-f305-0000003bf2d7", name: "Leon Braun" },
    "balance_cents": 0
  },
  {
    "member": { id: "99999999-0062-0006-913c-0000003c910e", name: "Lotte Albrecht" },
